...
"""
    ...
    Description : Modern, Professional Gradio Chat Interface for SkillForge
...
from skillforge.ui.settings.provider_tab import create_provider_tab
from skillforge.ui.settings.skills_tab import create_skills_tab
from skillforge.ui.chat.handlers import chat_with_bot
import config

from skillforge.ui.settings.provider_tab import check_local_server_status, get_server_start_command
...
with gr.Blocks(
    ...
    with gr.Row(elem_classes="header-container"):
        ...
        <div style="text-align: center; padding: 2rem;">
            <img src="file/icon/icon.png" alt="SkillForge" style="width: 80px; height: 80px; margin-bottom: 0.5rem;">
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    print("🚀 Starting SkillForge Modern Interface")
    print("=" * 60)
    print(f"🤖 Bot Name: SkillForge")
    print(f"🧠 Provider: {llm_provider.provider_name}")
    print(f"🎯 Model: {llm_provider.model_name}")
