...
class AnthropicProvider(LLMProvider):
    ...
    def format_vision_messages(
        ...
        Converts the last user message content to:
            [
        ...
        Returns:
            Modified messages with the last user message in Anthropic
            multi-part vision format.
        """
        if not attachments:
            return messages
        ...
        # Anthropic format: images first, then text
