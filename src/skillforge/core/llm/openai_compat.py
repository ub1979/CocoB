...
class OpenAICompatibleProvider(LLMProvider):
    ...
    def supports_vision(self) -> bool:
        ...
        Returns True because most OpenAI-compatible APIs support vision
        when a vision-capable model is used. The router decides whether
        to call format_vision_messages based on this flag.
        """
        return True
    ...
    def format_vision_messages(
        ...
        Returns:
            Modified messages with the last user message in multi-part format.
        """
        if not attachments:
            return messages
