...
class MCPPanel:
    ...
    def _populate_mcp_servers(self):
        ...
        MCPManager = None
        try:
            from coco_b.core.mcp_client import MCPManager as _MCPManager
        ...
        card_content = ft.Column([
            ft.Row([
                ...
                ft.Container(
                    ...
                    bgcolor=status_color + "20", padding=ft.padding.symmetric(horizontal=8, vertical=4),
    ...
    def _add_mcp_server_dialog(self, e):
        ...
        def add_server(e):
            ...
            try:
                from coco_b.ui.settings.mcp_models import MCPServerConfig
