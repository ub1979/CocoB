...
Run coco B as a Telegram bot with persistent memory, skills, and MCP tools.
...
logger = logging.getLogger("coco_b_telegram")


class CocoBTelegramBot:
    """coco B Telegram Bot with full feature support."""
    ...
    def _get_saved_provider(self) -> str:
        ...
        try:
            storage_file = Path.home() / ".coco_b" / "secure_config.json"
    ...
    def initialize(self):
        ...
        logger.info("Initializing coco B Telegram bot...")
